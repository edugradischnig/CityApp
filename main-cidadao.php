    ...
    <section class="envelope envelope--p">
        <div style="padding-top:60px;">
            ...
            for ($i=0; $i < mysqli_num_rows($resultado); $i++) {
                ...
                echo "<h1 class='texto-titulo texto-titulo--h1' style='color:var(--cor-principal-5)'>".$linha['resumo']."</h1>";
                echo "<p class='texto-corpo' style='margin-top:8px; color:var(--cor-branco-2);'>".$linha['descricao']."</p>";
                echo "<h2 class='texto-titulo texto-titulo--h2' style='margin-top:16px; color:var(--cor-principal-3);'>Localização</h2>";
                echo "<div class='objeto-recipiente' style='border:2px solid #fff; margin-top:8px;'>";
                echo "<iframe src=https://maps.google.com/maps?q=".$linha['y_coord'].",".$linha['x_coord']."&z=15&output=embed class=1objeto-conteudo1></iframe>";
